    ...
    >
        ...
        <div class="md:w-1/2 my-auto mx-auto sm:px-6 lg:px-8 shadow-2xl p-12">
            ...
            <div class="flex justify-center" v-else>
                <Link
                    :href="route('login')"
                    class="text-xl mr-4 border border-red-500 rounded p-2 text-red-500"
                    >Sign in</Link
                >

                <Link
                    :href="route('register')"
                    class="text-xl border border-purple-900 rounded p-2 text-purple-500"
                    >Sign up</Link
                >
            </div>

            <p class="text-center mt-5 text-lg">Contact me @</p>
            <div class="flex justify-center mt-2">
                <div>
                    <a class="" href="https://github.com/jude4/">
                        <svg
                            class="w-8 h-9"
                ...
                <div class="mx-2">
                    <a
                        href="http://linkedin.com/in/jude-onohwosafe-6b6816167"
                        target="__blank"
                    >
                        <svg
                            class="h-8 w-8"
